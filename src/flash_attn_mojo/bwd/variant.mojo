...
def bwd_main_variant(
    ...
    var window_left: Int = Int(py=args[12])
    var window_right: Int = Int(py=args[13])
    var batch_int: Int = Int(py=args[14])
    var seqlen_int: Int = Int(py=args[15])
    var nheads_q_int: Int = Int(py=args[16])
