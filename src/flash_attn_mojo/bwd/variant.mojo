...
def bwd_main_variant(
    ...
    var nheads_int: Int = Int(py=args[11])
    var softmax_scale: Float32 = Float32(py=args[12])
    var q_b_stride: Int = Int(py=args[13])
    var q_l_stride: Int = Int(py=args[14])
    var q_h_stride: Int = Int(py=args[15])
    var k_b_stride: Int = Int(py=args[16])
    var k_l_stride: Int = Int(py=args[17])
    var k_h_stride: Int = Int(py=args[18])
    var v_b_stride: Int = Int(py=args[19])
    var v_l_stride: Int = Int(py=args[20])
    var v_h_stride: Int = Int(py=args[21])
    var do_b_stride: Int = Int(py=args[22])
    var do_l_stride: Int = Int(py=args[23])
    var do_h_stride: Int = Int(py=args[24])
    var dk_b_stride: Int = Int(py=args[25])
    var dk_l_stride: Int = Int(py=args[26])
    var dk_h_stride: Int = Int(py=args[27])
    var dv_b_stride: Int = Int(py=args[28])
    var dv_l_stride: Int = Int(py=args[29])
    var dv_h_stride: Int = Int(py=args[30])
    var lse_b_stride: Int = Int(py=args[31])
    var lse_h_stride: Int = Int(py=args[32])
    var delta_b_stride: Int = Int(py=args[33])
    var delta_h_stride: Int = Int(py=args[34])
    var dqa_b_stride: Int = Int(py=args[35])
